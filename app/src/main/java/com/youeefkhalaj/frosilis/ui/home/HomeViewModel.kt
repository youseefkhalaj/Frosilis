 ...
 */
class HomeViewModel(personalsRepository: PersonalsRepository) : ViewModel() {

    val homeUiState: StateFlow<HomeUiState> =
        personalsRepository.getAllPersonalsStream().map { HomeUiState(it) }
            .stateIn(
 ...
 */
data class HomeUiState(val personalItemList: List<Personal> = listOf())
